...
class Tphc19_Filter_interface extends TydiModule {
  ...
  val L_ShipInstructIn = lineItemsInStream.el.L_ShipInstruct.flip.toPhysical
  val L_ShipModeIn = lineItemsInStream.el.L_ShipMode.flip.toPhysical
  val L_CommentIn = lineItemsInStream.el.L_Comment.flip.toPhysical
  val L_CommitDateIn = lineItemsInStream.el.L_CommitDate.flip.toPhysical
  val L_LineStatusIn = lineItemsInStream.el.L_LineStatus.flip.toPhysical
  val L_ReceiptDateIn = lineItemsInStream.el.L_ReceiptDate.flip.toPhysical
  val L_ReturnFlagIn = lineItemsInStream.el.L_ReturnFlag.flip.toPhysical
  val L_ShipDateIn = lineItemsInStream.el.L_ShipDate.flip.toPhysical
  ...
  val P_ContainerIn = partsInStream.el.P_Container.flip.toPhysical
  val P_BrandIn = partsInStream.el.P_Brand.flip.toPhysical
  val P_MfgrIn = partsInStream.el.P_Mfgr.flip.toPhysical
  val P_NameIn = partsInStream.el.P_Name.flip.toPhysical
  val P_CommentIn = partsInStream.el.P_Comment.flip.toPhysical
  val P_TypeIn = partsInStream.el.P_Type.flip.toPhysical
